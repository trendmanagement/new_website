...
class Services extends Component {
    ...
    getContent() {
        ...
        switch (this.props.location.pathname) {
            ...
            case '/robo-hedger': {
                return (<div className="service-options__container-grid-block">
            ...
            case '/tech-services': {
                return (<div className="service-options__container-grid-block">
                    ...
                    <div className="service-options__list-description">
                        ...
                        market maker, investment advisers, fund sponsors or proprietary trading groups.
                </div>
                    <div className="service-options__btn-container">
                        <Link to="/tell-about"><div className="service-options__btn-container_btn">FIND OUT MORE</div></Link>
                    </div>
                ...
                return (<div className="service-options__container-grid-block">
                     <h5 className="service-options__title">Value / Unique Selling proposition</h5>
                      <div className="service-options__list-description">
                        ...
                        where sophisticated firms can develop, test, deploy and refine algorithmic investment, hedging risk, or trading strategies in the global exchanged traded derivatives markets.
                    </div>
                    <div className="service-options__btn-container">
                        <Link to="/tell-about"><div className="service-options__btn-container_btn">FIND OUT MORE</div></Link>
                    </div>
